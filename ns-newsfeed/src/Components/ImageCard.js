...
function ImageCard(props) {
  return (
    <div className="mt-4 bg-theme-analog rounded-lg shadow">
      <div className="p-3 flex cursor-pointer space-x-2">
      ...
      <div className="flex justify-center w-full bg-gray-200">
        <img alt="feed pic" className="max-h-96" src={props.feed.imgUrl} />
      </div>
      ...
      <div className="flex cursor-pointer justify-between border-t-2 border-b-2 border-fuchsia-600 mx-3 mb-4 mt-2 lg:px-32 py-1">
